...
// Helper component for conditional Tailwind classes
      ...
      `}>
        ...
        <div className="p-6 border-b border-gray-700">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-gray-400 text-sm">ThriftX Marketplace</p>
            </div>
          </div>
        </div>
        ...
        <div className="p-4 border-t border-gray-700">
          <button
            ...
            className="w-full flex items-center gap-3 px-4 py-3 text-gray-300 hover:bg-gray-700 hover:text-white rounded-xl transition-all duration-200"
          >
            <LogOut size={20} />
            Logout
          </button>
  ...
  const fetchDashboardData = async () => {
    try {
      ...
      try {
        ...
        usersData = usersSnapshot.docs.map(doc => ({ id: doc.id, ...doc.data(), isActive: doc.data().isActive ?? true }));
        setUsers(usersData);
      } catch (error) {
      ...
      try {
        ...
        productsData = productsSnapshot.docs.map(doc => ({ id: doc.id, ...doc.data(), isApproved: doc.data().isApproved ?? false }));
  ...
  return (
    <div className="min-h-screen bg-gray-50 flex">
      ...
      <div className="flex-1 lg:ml-0">
        ...
        {/* Top Header Bar */}
        <header className="bg-white shadow-sm border-b border-gray-200 lg:static sticky top-0 z-30">
          <div className="flex items-center justify-between p-4">
            <div className="flex items-center gap-4">
              ...
              <h1 className="text-2xl font-bold text-gray-900">
                ...
                {activeTab === 'products' && 'Product Oversight'}
            ...
            <div className="flex items-center gap-4">
              <div className="hidden md:flex items-center gap-2 px-4 py-2 rounded-full font-semibold text-white 
